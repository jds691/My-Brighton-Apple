...
/// Represents an error generated by the Learn REST API.
public struct RestError: Error {
    /// HTTP status code returned by the error.
    public private(set) var statusCode: Int?
    public private(set) var errorCode: String?
    /// The actual error message.
    public private(set) var message: String
    /// Additional developer information returned by the Learn API.
    public private(set) var developerMessage: String?
    /// Extra debugging information returned by the Learn API.
    public private(set) var extraInfo: String?
    
    /// Initialises an error from a remote RestException from the Learn API.
    /// - Parameter restException: OpenAPI schema that the error is modeled after.
